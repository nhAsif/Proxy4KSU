...
Download the module zip from [Release](https://github.com/nhAsif/Proxy4KSU/releases) and install it via [Magisk](https://github.com/topjohnwu/Magisk)
...
- The adguardhome config file is stored in `/data/adb/xray/adghomeconfs/config.yaml`, and the default username and password are both `proxy4ksu`
...
XrayHelper is used in version 3.0 and above, for more detailed configuration please refer to [XrayHelper](https://github.com/nhAsif/XrayHelper/blob/master/README.md)
...
2. You can clean xray data dir by running command `rm -rf /data/adb/xray && rm -rf /data/adb/service.d/proxy4ksu_service.sh` .
...
[XrayHelper](https://github.com/nhAsif/XrayHelper), A unified proxy helper for  Android, some scripts in Proxy4KSU rewritten with golang, provide arm64 and amd64 binary.
